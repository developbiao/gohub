...
// Set Implement base64Captcha.Store interface
func (s *RedisStore) Set(key string, value string) error {
	...
	if ok := s.RedisClient.Set(s.KeyPrefix+key, value, ExpireTime); !ok {
		return errors.New("can not save captcha answer")
	}
	return nil
}

// Get implement base64Captcha.Get interface
...
// Verify implement base64Captcha verify interface
